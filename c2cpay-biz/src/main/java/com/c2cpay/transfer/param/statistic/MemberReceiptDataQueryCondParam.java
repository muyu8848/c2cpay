...
@Data
public class MemberReceiptDataQueryCondParam {
	...
	public Specification<MemberEverydayReceiptData> buildSpecification() {
		MemberReceiptDataQueryCondParam param = this;
		Specification<MemberEverydayReceiptData> spec = new Specification<MemberEverydayReceiptData>() {
			/**
			 * 
			 */
			private static final long serialVersionUID = 1L;

			public Predicate toPredicate(Root<MemberEverydayReceiptData> root, CriteriaQuery<?> query,
