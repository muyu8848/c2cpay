...
@Data
public class MerchantTransferDataQueryCondParam {
	...
	public Specification<MerchantEverydayTransferData> buildSpecification() {
		MerchantTransferDataQueryCondParam param = this;
		Specification<MerchantEverydayTransferData> spec = new Specification<MerchantEverydayTransferData>() {
			/**
			 * 
			 */
			private static final long serialVersionUID = 1L;

			public Predicate toPredicate(Root<MerchantEverydayTransferData> root, CriteriaQuery<?> query,
