package com.c2cpay.common.operlog;
...
import com.c2cpay.log.service.OperLogService;
...
public class OperLogAspect {
	...
	@Pointcut("@annotation(com.c2cpay.common.operlog.OperLog)")
	...
	public void recordOperLog(JoinPoint joinPoint, Exception e, Object result) {
		...
		com.c2cpay.log.domain.OperLog operLog = new com.c2cpay.log.domain.OperLog();
